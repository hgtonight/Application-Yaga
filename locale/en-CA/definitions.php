...
$Definition['Yaga.Rules.CommentMarathon.Desc'] = 'This rule checks a users comment count within the past duration. If it is a greater than or equal to the target, it will return true.';
...
$Definition['Yaga.Rules.ManualAward.Desc'] = 'This rule will <strong>never</strong> be awarded <em>automatically</em>. Use it for badges you want to hand out manually.';
